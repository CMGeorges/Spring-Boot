...
public class MovieRepository implements IMovieRepository{
    ...
    public List<Movie> list() {
        return jdbcTemplate.query("SELECT TITLE,GENRE FROM MOVIE",(rs,rowNum)->
                new Movie(rs.getString("TITLE"),rs.getString("GENRE")));
    }

    @Override
    public Movie getById(long id) {
        return jdbcTemplate
                .queryForObject("TITLE,GENRE,DESCRIPTION FROM MOVIE WHERE ID=?",
                        new Object[]{id},
                        (rs,rowUm)->new Movie(rs.getString("TITLE"),
